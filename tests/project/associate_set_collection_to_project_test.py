...
from project_pb2 import AssociateSetCollectionsToProjectRequest
from knitter_client import get_knitter_client_stub, login
from knitter_services.project import associate_set_collections_to_project
...
async def main():
    ...
    request = AssociateSetCollectionsToProjectRequest(
        project_id = "0",
        collection_ids = ["0", "1"]
    )

    ok, m_response, details = await associate_set_collections_to_project(

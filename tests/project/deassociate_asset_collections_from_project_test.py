...
from knitter_services.project import deassociate_asset_collections_from_project
...
async def main():
    ...
    request = DeassociateAssetCollectionsFromProjectRequest(
        project_id = "0",
        collection_ids = ["0", "1"]
    )

    ok, m_response, details = await deassociate_asset_collections_from_project(

...
from project_pb2 import DeassociateSetCollectionsFromProjectRequest
...
async def main():
    ...
    request = DeassociateSetCollectionsFromProjectRequest(
        project_id = "0",
        collection_ids = ["0", "1"]
    )

    ok, m_response, details = await deassociate_set_collections_from_project(

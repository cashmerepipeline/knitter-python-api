...
from asset_collection_pb2 import GetAssetCollectionAssetTotalCountRequest
from knitter_services.asset_collection import get_asset_collection_asset_total_count
...
async def main():
    ...
    request = GetAssetCollectionAssetTotalCountRequest(
            collection_id = "1",
    )

    ok, m_response, details = await get_asset_collection_asset_total_count(

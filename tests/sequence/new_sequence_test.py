...
from knitter_services.sequence import new_sequence
from sequence_pb2 import NewSequenceRequest
...
async def main():
    ...
    name = Name(language="zh", name="测试章节")
    ...
    ok, m_response, details = await new_sequence(

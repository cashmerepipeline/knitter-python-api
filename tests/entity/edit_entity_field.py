...
from common_services.entity import edit_entity_field, get_entity
from id_codes.general_field_ids import OWNER_FIELD_ID
from id_codes.manage_ids import MANAGES_MANAGE_ID
from entity_pb2 import EditEntityFieldRequest
...
async def main():
    ...
    ok, m_response, details = await edit_entity_field(

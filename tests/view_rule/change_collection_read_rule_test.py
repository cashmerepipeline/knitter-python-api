...
from common_services.view_rule import change_collection_read_rule
...
from view_pb2 import ChangeCollectionReadRuleRequest
...
async def main():
    ...
    # get manages count
    request = ChangeCollectionReadRuleRequest(manage_id=MANAGES_MANAGE_ID, group_id="10001", read_rule="InVisible")

    ok, m_response, details = await change_collection_read_rule(

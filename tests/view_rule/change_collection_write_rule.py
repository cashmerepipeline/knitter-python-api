...
from common_services.view_rule import change_collection_write_rule
...
from view_pb2 import ChangeCollectionWriteRuleRequest
...
async def main():
    ...
    # get manages count
    request = ChangeCollectionWriteRuleRequest(manage_id=MANAGES_MANAGE_ID, group_id="10001", write_rule="InVisible")

    ok, m_response, details = await change_collection_write_rule(

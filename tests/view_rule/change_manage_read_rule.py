...
from common_services.view_rule import change_collection_read_rule, change_manage_read_rule
...
from view_pb2 import ChangeManageReadRuleRequest
...
async def main():
    ...
    # get manages count
    request = ChangeManageReadRuleRequest(manage_id=MANAGES_MANAGE_ID, group_id="10001", read_rule="InVisible")

    ok, m_response, details = await change_manage_read_rule(

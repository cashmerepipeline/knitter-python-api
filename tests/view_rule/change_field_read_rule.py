...
from common_services.view_rule import change_collection_write_rule, change_field_read_rule, change_field_write_rule
...
from view_pb2 import ChangeFieldReadRuleRequest
...
async def main():
    ...
    # get manages count
    request = ChangeFieldReadRuleRequest(manage_id=MANAGES_MANAGE_ID, group_id="10001", field_id=str(MANAGES_SCHEMA_FIELD_ID), read_rule="InVisible")

    ok, m_response, details = await change_field_read_rule(

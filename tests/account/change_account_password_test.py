...
import bson
from common_services.account import change_account_password, change_own_password, new_account
...
from password_pb2 import ChangeAccountPasswordRequest
...
async def main():
    ...
    request = ChangeAccountPasswordRequest(
            account_id = "8610000000000",
            new_password = "123456"
            )

    ok, m_response, details = await change_account_password(
